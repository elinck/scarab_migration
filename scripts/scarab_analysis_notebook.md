...
r<sup>2</sup> value of 0.6:

``` bash
bcftools +prune -l 0.6 -w 1000 d_satanas_filtered.FIL.recode.vcf -Ov -o d_satanas.LD.vcf
bcftools +prune -l 0.6 -w 1000 d_spec_filtered.FIL.recode.vcf -Ov -o d_spec.LD.vcf
bcftools +prune -l 0.6 -w 1000 d_tess_filtered.FIL.recode.vcf -Ov -o d_tess.LD.vcf
bcftools +prune -l 0.6 -w 1000 d_pod_filtered.FIL.recode.vcf -Ov -o d_pod.LD.vcf
bcftools +prune -l 0.6 -w 1000 e_affin_filtered.FIL.recode.vcf -Ov -o e_affin.LD.vcf
```
